...
public class MonitoringIhmApp {

    private static final Logger log = LoggerFactory.getLogger(MonitoringIhmApp.class);

    private final Environment env;

    public MonitoringIhmApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes monitoringIhm.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MonitoringIhmApp.class);
